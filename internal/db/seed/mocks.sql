...
INSERT INTO profile (user_id, first_name, last_name, phone, avatar_url) VALUES
  ('40000000-0000-0000-0000-000000000001', 'Alex', 'Petrov', '+79001234567', 'http://localhost:8080/api/v1/image/default_avatar.jpg'),
  ('40000000-0000-0000-0000-000000000002', 'Maria', 'Ivanova', '+79007654321', 'http://localhost:8080/api/v1/image/default_avatar.jpg');
...
INSERT INTO complex_photo (complex_id, url) VALUES
  ('50000000-0000-0000-0000-000000000002', 'http://localhost:8080/api/v1/image/default_complex.jpg'),
  ('50000000-0000-0000-0000-000000000002', 'http://localhost:8080/api/v1/image/default_complex.jpg'),
  ('50000000-0000-0000-0000-000000000003', 'http://localhost:8080/api/v1/image/default_complex.jpg');
...
INSERT INTO offer_photo (offer_id, url) VALUES
  ('60000000-0000-0000-0000-000000000003', 'http://localhost:8080/api/v1/image/default_offer.jpg'),
  ('60000000-0000-0000-0000-000000000003', 'http://localhost:8080/api/v1/image/default_offer1.jpg'),
  ('60000000-0000-0000-0000-000000000004', 'http://localhost:8080/api/v1/image/default_offer2.jpg'),
  ('60000000-0000-0000-0000-000000000005', 'http://localhost:8080/api/v1/image/default_offer3.jpg'),
  ('60000000-0000-0000-0000-000000000005', 'http://localhost:8080/api/v1/image/default_offer4.jpg'),
  ('60000000-0000-0000-0000-000000000005', 'http://localhost:8080/api/v1/image/default_offer5.jpg'),
  ('60000000-0000-0000-0000-000000000006', 'http://localhost:8080/api/v1/image/default_offer6.jpg');